    ...
    <div className="relative min-h-screen bg-[#fafafa] w-full font-sans pb-24 selection:bg-blue-100 selection:text-blue-900">
      ...
      <div className="relative z-10 pt-24 md:pt-32">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-10 md:mb-16 animate-fade-in-up">
          <div className="inline-flex items-center justify-center w-14 h-14 md:w-16 md:h-16 bg-white/80 backdrop-blur-xl text-blue-600 rounded-[1.25rem] md:rounded-3xl mb-5 md:mb-6 shadow-sm border border-white">
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
          <div className="bg-white/40 backdrop-blur-xl rounded-[2rem] md:rounded-[2.5rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white/60 p-4 md:p-10 lg:p-12">
            ...
            {/* Top Bar */}
            <div className="flex flex-col sm:flex-row items-center justify-between border-b border-gray-200/50 pb-5 md:pb-6 mb-6 md:mb-10 gap-3">
              <h2 className="text-lg md:text-2xl font-extrabold text-gray-900">
                Network Directory
              </h2>
              {pagination && (
                <span className="text-[11px] md:text-xs font-extrabold text-blue-700 bg-blue-100/60 border border-blue-200 px-3 md:px-4 py-1.5 md:py-2 rounded-full uppercase tracking-widest shadow-sm">
                  {pagination.totalCount || providers.length} Available
                </span>
              )}
            </div>
